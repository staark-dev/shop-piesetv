...
<section class="section-pagetop bg">
    <div class="container">
        ...
        <ol class="breadcrumb text-white">
            ...
            <li class="breadcrumb-item"><a href="{{ route('cat.view', ['slug' => $cat->categories[0]->slug ]) }}">{{ $cat->categories[0]->name }}</a></li>
            <li class="breadcrumb-item"><a href="{{ route('cat.sub', ['catid' => $cat->categories[0]->id, 'slug' => $cat->slug ]) }}">{{ $cat->name }}</a></li>
